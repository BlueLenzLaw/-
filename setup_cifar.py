...
class CIFAR:
    def __init__(self):
        ...
        self.test_labels_one=np.reshape(np.argmax(self.test_labels,axis=1),[-1,1])
        ...
        train_labels_one=np.reshape(np.argmax(train_labels,axis=1),[-1,1])
        self.validation_labels_one = train_labels_one[:VALIDATION_SIZE]
        self.train_labels_one = train_labels_one[VALIDATION_SIZE:]
